...
public class ColorSelector extends View
{
    ...
    protected void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
        ...
        mColorListHeight = typedArray.getDimension(R.styleable.ColorSelector_colorListHeight, dp2px(10));
        mColorListWidth = typedArray.getDimension(R.styleable.ColorSelector_colorListWidth, dp2px(290));
        mDragBarRadius = typedArray.getDimension(R.styleable.ColorSelector_dragBarRadius, dp2px(10));
        getmColorIndicatorHeight = typedArray.getDimension(R.styleable.ColorSelector_colorIndicatorHeight, dp2px(20));
        mColorIndicatorWidth = typedArray.getDimension(R.styleable.ColorSelector_colorIndicatorWidth, dp2px(20));
        mColorListPaddingTop = typedArray.getDimension(R.styleable.ColorSelector_colorListPaddingTop, dp2px(5));
        typedArray.recycle();
    }
